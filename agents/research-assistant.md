...
1. Use PostPrint MCP tools (**postprint-dev**, **postprint-qa**, or **postprint** depending on which server is enabled) when the task involves papers, projects, library, search, citations, or bibliographies. Complete OAuth if the client requires it.
